                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{__('cms.create_specialty')}}</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{route('specialties.store')}}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name_en_input" name="name_en" value="{{old('name_en')}}" placeholder="{{__('cms.name_en')}}">
                                </div>
                                <div class="form-group">
                                    <label for="name_ar_input">{{__('cms.name_ar')}}</label>
                                    <input type="text" class="form-control" id="name_ar_input" name="name_ar" value="{{old('name_ar')}}" placeholder="{{__('cms.name_ar')}}">
                                </div>
                                <div class="form-group">
                                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                        <input type="checkbox" class="custom-control-input" id="activecheckbox" value="{{old('active')}}" name="active">
